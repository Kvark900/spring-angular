package com.kvark900.backend.services;

import com.kvark900.backend.dao.UserRepository;
...
public class UserService {
	...
	public User getUpdatedUser(User persistedUser, User updatedUser) {
		persistedUser.setName(updatedUser.getName());
		persistedUser.setSurname(updatedUser.getSurname());
		persistedUser.setUsername(updatedUser.getUsername());
		persistedUser.setEmail(updatedUser.getEmail());
		persistedUser.setRoles(getAssignedRolesList(updatedUser));
		persistedUser.setEnabled(updatedUser.isEnabled());
